        ...
        <form onSubmit={formik.handleSubmit} className="space-y-4 sm:space-y-5">
          ...
          <div>
            ...
            <select
              id="role"
              name="role"
              className="w-full px-3 py-2 sm:px-4 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors text-sm sm:text-base bg-white"
            ...
            {formik.touched.role && formik.errors.role && (
              <p className="text-red-500 text-xs sm:text-sm mt-1">{formik.errors.role}</p>
            )}
          </div>
